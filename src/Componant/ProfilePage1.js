    ...
    <div className='profile'>
      ...
      {user && (
        <div className='info'>
           ...
           <h3>Username: <span>{user.username
}</span></h3>
           ...
           <h3>Address: <span>{user.address?.address
},{user.address?.city
},{user.address?.state},{user.address?.postalCode
}</span></h3>
<h3>Company: <span>{user.company
?.name}</span></h3>
<h3>departMent: <span>{user.company
?.department}</span></h3>
<h3>domain: <span>{user.domain}</span></h3>
<h3>Height: <span>{user.height
}</span></h3>
<h3>Univercity: <span>{user.university
}</span></h3>
<h3>UserAgent: <span>{user.userAgent
